...
__all__ = ['LighthouseViewer']

logger = logging.getLogger(__name__)

lighthouse_viewer_class = uic.loadUiType(
    cfclient.module_path + "/ui/tabs/lighthouse_viewer.ui")[0]
...
class LighthouseViewer(Tab, lighthouse_viewer_class):
    ...
    def __init__(self, tabWidget, helper, *args):
        super(LighthouseViewer, self).__init__(*args)
        self.setupUi(self)

        self.tabName = "Lighthouse Viewer"
        self.menuName = "Lighthouse Viewer Tab"
        ...
        # self.origin_le = QtWidgets.QLineEdit(self)
        # self.rotation_le = QtWidgets.QLineEdit()

        self.UpdateButton.clicked.connect(self.btn_clk)
    ...
    def _update_graphics(self):
        if self.is_visible() and self.is_lighthouse_deck_active:
            ...
            # orange = self._lh_geos[0]
            # print(orange.origin)
            # print(type(self._lh_geos[0]))
            self._update_position_label(self._helper.pose_logger.position)
